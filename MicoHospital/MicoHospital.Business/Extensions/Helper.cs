...
namespace MicoHospital.Business.Extensions
{
    public static class Helper
    {
        public static string SaveFile(string rootPath, string folder, IFormFile file)
        {
            if (file.ContentType != "image/png" && file.ContentType != "image/jpeg")
                throw new ImageContentTypeException("Imgae formati duzgun deyil!");

            if (file.Length > 2097152)
                throw new ImageSizeException("Image 2mb ola biler!");
